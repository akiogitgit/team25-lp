      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='border border-gray-500 py-10'>
          ...
          <ul className='text-start px-10 pt-10 list-decimal'>
            ...
            <li>"「食わず嫌い」から解放しろ！未知に最前線で挑戦し続けよ！"</li>
            <li>
              "チャンスを自分で掴み取れ！待ってはいけない、行動するんだ！"
            </li>
            <li>"未来はお前が切り開く！自分の力を信じて一歩進み続けろ！"</li>
            <li>
            ...
            <li>"失敗から学びたまえ！それは成功への踏み台となる！"</li>
            <li>"常に心を開け！新たな可能性に、常にオープンな心で臨め！"</li>
            <li>"リーダーシップを発揮せよ！周りを導き、自らも成長し続けろ！</li>
          </ul>
        </div>
